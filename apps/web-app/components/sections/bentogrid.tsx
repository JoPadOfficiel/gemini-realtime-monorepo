          ...
          <div className="relative col-span-full flex overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-2">
            <div className="relative m-auto size-fit">
              <div className="relative flex h-24 w-56 items-center">
                ...
                <span className="text-gradient_arkely mx-auto block w-fit font-heading text-5xl">
                  AI
                </span>
              </div>
            ...
            <div>
              <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border before:bg-muted/20 dark:before:border-white/5">
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      <stop stopColor="#387ff5" stopOpacity="0" />
                      <stop
                        className="text-primary"
                        offset="1"
              ...
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                ...
                <p className="text-muted-foreground">
                  Encrypted conversations and protected data. Your privacy
                  is our absolute priority with ARKELY.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
            <div>
              <div className="flex items-center justify-center py-8">
                ...
                >
                  {/* App Circle */}
                  <circle cx="60" cy="60" r="30" fill="#FFA726" />
                  <g transform="translate(50, 50)">
                    <circle cx="2" cy="2" r="1.5" fill="#8D6E63" />
                    <circle cx="8" cy="2" r="1.5" fill="#8D6E63" />
                    <circle cx="14" cy="2" r="1.5" fill="#8D6E63" />
                    <circle cx="2" cy="8" r="1.5" fill="#8D6E63" />
                    <circle cx="8" cy="8" r="1.5" fill="#8D6E63" />
                    <circle cx="14" cy="8" r="1.5" fill="#8D6E63" />
                    <circle cx="2" cy="14" r="1.5" fill="#8D6E63" />
                    <circle cx="8" cy="14" r="1.5" fill="#8D6E63" />
                    <circle cx="14" cy="14" r="1.5" fill="#8D6E63" />
                  </g>

                  {/* Live API Circle */}
                  <circle cx="340" cy="60" r="30" fill="#B39DDB" />
                  {/* Star icon for Live API */}
                  <g transform="translate(340, 60)">
                    <path d="M0 -8 L2 -2 L8 -2 L3 2 L5 8 L0 4 L-5 8 L-3 2 L-8 -2 L-2 -2 Z" fill="white" />
                  </g>

                  {/* Top line with arrow - Text, audio, video */}
                  <line x1="95" y1="45" x2="305" y2="45" stroke="#999" strokeWidth="2" />
                  <polygon points="305,45 300,42 300,48" fill="#999" />
                  <text x="200" y="35" textAnchor="middle" className="fill-foreground text-xs font-medium">
                    Text, audio, video
                  </text>

                  {/* Bottom line with arrow - Text, audio */}
                  <line x1="305" y1="75" x2="95" y2="75" stroke="#999" strokeWidth="2" />
                  <polygon points="95,75 100,72 100,78" fill="#999" />
                  <text x="200" y="90" textAnchor="middle" className="fill-foreground text-xs font-medium">
                    Text, audio
                  </text>

                  {/* WebSocket connection text */}
                  <text x="200" y="105" textAnchor="middle" className="fill-muted-foreground text-xs">
                    Connect via WebSocket
                  </text>

                  {/* App label */}
                  <text x="60" y="105" textAnchor="middle" className="fill-foreground text-sm font-semibold">
                    App
                  </text>

                  {/* Live API label */}
                  <text x="340" y="105" textAnchor="middle" className="fill-foreground text-sm font-semibold">
                    Live API
                  </text>
                </svg>
              </div>
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                ...
                <p className="text-muted-foreground">
                  Real-time interactions with Gemini Live. Fluid and
                  natural conversations without latency.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Audio, video, text and images. ARKELY understands and responds
                    in all formats.
                  </p>
                </div>
              </div>
              <div className="relative -mb-10 -mr-10 mt-8 h-fit rounded-tl-xl border bg-muted/30 pt-6 sm:ml-6 sm:mt-auto">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 h-2 bg-muted rounded-full overflow-hidden">
                      <div className="h-full w-5/6 bg-gradient-to-r from-green-500 to-blue-500 rounded-full"></div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="size-8 rounded-lg bg-blue-500/20 flex items-center justify-center">
                ...
                <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:bg-white/5 dark:before:border-white/5 dark:before:bg-white/5">
                  ...
                  >
                    <path
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2m8-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm6 0v6m3-3h-6"
                    />
                  </svg>
                </div>
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Share your conversations and work together with
                    the most advanced AI.
                  </p>
                </div>
              </div>
              <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-primary/50 sm:-my-8 sm:-mr-8">
                <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                  <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                    ...
                    <div className="size-7 ring-4 ring-background">
                      <Image
                        ...
                        src="https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah&backgroundColor=b6e3f4,c0aede,d1d4f9"
                        alt="Sarah avatar"
                        unoptimized
                      />
                    </div>
                  ...
                  <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                    <div className="size-8 ring-4 ring-background">
                      <div className="size-full rounded-full border bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center">
                        <svg className="size-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2ZM21 9V7L15 1L13.5 2.5L16.17 5.17C15.24 5.06 14.32 5 13.4 5H10.6C9.68 5 8.76 5.06 7.83 5.17L10.5 2.5L9 1L3 7V9H5V20C5 21.1 5.9 22 7 22H17C18.1 22 19 21.1 19 20V9H21Z"/>
                        </svg>
                      </div>
                    </div>
                    <span className="block h-fit rounded-md border bg-muted/50 px-2 py-1 text-xs">
                  ...
                  <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                    ...
                    <div className="size-7 ring-4 ring-background">
                      <Image
                        ...
                        height={100}
                        className="size-full rounded-full border"
                        src="https://api.dicebear.com/7.x/avataaars/svg?seed=Alex&backgroundColor=ffd5dc,ffdfbf,c0aede"
                        alt="Alex avatar"
                        unoptimized
                      />
                    </div>
