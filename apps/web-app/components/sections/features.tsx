      ...
      <div className="pb-6 pt-28">
        <MaxWidthWrapper>
          <HeaderSection
            ...
            subtitle="Discover the advanced features that make ARKELY the most intelligent and intuitive AI assistant for real-time conversations and collaboration."
          />
