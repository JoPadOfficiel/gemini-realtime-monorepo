...
export async function updateModelPricing(
  ...
  return await prisma.modelPricing.update({
    where: { modelId },
    data: {
      textInputPricePerMillion: pricing.inputPricePerMillion,
      textOutputPricePerMillion: pricing.outputPricePerMillion,
      audioInputPricePerMillion: pricing.audioPricePerMillion,
      audioOutputPricePerMillion: pricing.audioPricePerMillion, // Assuming same price for audio input/output
    },
  });
}
